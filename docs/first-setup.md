...
- **`livery agents`** — list hired agents, their runtimes/models, and the working directories they operate in. Add `--format json` when a harness skill needs valid assignee ids.
