...
CAPABILITIES: tuple[Capability, ...] = (
    ...
    Capability(
        ...
        commands=(
            ...
            "livery ticket update <ticket-id> --kind progress --message \"...\"",
            "livery status",
        ...
        agent_note="Prefer JSON output when operating from a harness; use ticket update for distilled milestones instead of hand-editing markdown or copying raw logs.",
    ),
    Capability(
        id="memory",
    ...
    Capability(
        ...
        commands=(
            "livery dispatch status",
            "livery dispatch status --format json",
            "livery dispatch tail <query>",
        ),
